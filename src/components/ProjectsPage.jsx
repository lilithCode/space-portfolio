...
const ProjectsPage = () => {
  ...
  return (
    <div className="relative text-white min-h-screen">
      ...
      <section className="container mx-auto py-16 px-4 md:px-16">
          ...
          {projectsData.map((project, index) => (
            ...
            >
              <div className="relative w-full md:w-2/3">
                <div className="absolute top-4 left-4 md:top-8 md:left-8 bg-[#B069DB] w-full h-full rounded-lg" />
                <img
                  src={project.image}
                  alt={project.title}
                  className="relative w-full max-w-full rounded-lg shadow-lg"
                />
              </div>
